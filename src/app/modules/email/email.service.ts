...
import { interviewReportHtml, interviewReportTemplate } from "./email.template";
...
export async function sendInterviewReportForInterview(
  ...
  const summary =
    evaluation?.summary ?? "Your interview evaluation is being prepared.";
  const reportSummary = [
    summary,
    ...
    evaluation?.problemSolvingScore != null
      ? `Problem-solving score: ${evaluation.problemSolvingScore}/100`
      : "",
